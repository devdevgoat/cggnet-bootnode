...
echo "Starting the developer node, you'll need to enter your password next. Run ./console.bat to connect to the node locally and access the JS console."
geth --allow-insecure-unlock --unlock %addr% --datadir data --networkid 201601988 --nodiscover --http --http.port 6437 --http.api personal,eth,net,web3 --http.corsdomain "*" --bootnodes "enode://f29b759ca8c6d65b57fdce8180c0ac226b1802a23ed6aaf7273b39ecd135192574e2754211c5e1a390df53d7d0f229d3cdb23c4a61cc9a29d1a15923f0b05eb6@35.173.216.249:30303?discport=0"
